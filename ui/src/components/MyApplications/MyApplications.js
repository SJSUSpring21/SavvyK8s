        ...
        if(this.state.applications.length>0 ){
            appsSelected=  this.state.applications.map(app=>{
                ...
                return (
                    ...
                    <span>  <input type="checkbox"  checked={checked} value={app.appId} onChange={(e)=>this.appSelected(e,app)} />{app.appName} <br/></span>
                    );
                else
                return (
           
                  <span>  <input type="checkbox" value={app.appId} onChange={(e)=>this.appSelected(e,app)} />{app.appName} <br/></span>
                  );
            })
        }
        return(
